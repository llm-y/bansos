...
Write-Host "[1/5] Detected Architecture: $Arch"
Write-Host "[2/5] Downloading latest release of $AssetName..."
...
# Download binary
Write-Host "[3/5] Installing to $DestPath..."
...
Write-Host "[5/5] Adding Windows Defender exclusion..."
try {
